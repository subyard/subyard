...
grep -Fq -- '--user 0 --group 0 --env HOME=/home/dev --cwd /home/dev -- /usr/sbin/runuser -u dev -- true' "$INCUS_LOG"
...
grep -Fq -- '--user 0 --group 0 --env HOME=/home/dev --cwd /srv/workspaces/subyard-id/src -- /usr/sbin/runuser -u dev -- pwd' "$INCUS_LOG"
