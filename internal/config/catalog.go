...
var catalog = map[string]SettingDefinition{
	...
	"YARD_IMAGE": scalar("yard-runtime", SettingImageReference, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	"YARD_IMAGE_FALLBACK": scalar("yard-runtime", SettingImageReference, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	...
	"DEV_USER": scalar("yard-runtime", SettingName, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	"E2E_DISK_BUDGET": scalar("test-vms", SettingSize, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	"E2E_CACHE_BUDGET": scalar("test-vms", SettingSize, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	"E2E_DISK_RESERVE": scalar("test-vms", SettingSize, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	"E2E_MEMORY_RESERVE": scalar("test-vms", SettingSize, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	"E2E_VM_OVERHEAD": scalar("test-vms", SettingSize, SettingYardInit, true,
		scopes(ScopeShipped, ScopeShared, ScopeHost, ScopeYard, ScopeCommand)),
	...
	"YARD_MOUNTS": scalar("environment-profile", SettingMountList, SettingYardInit, true,
		scopes(ScopeShipped, ScopeHost, ScopeYard, ScopeCommand), optional()),
	"ENVIRONMENT_PROFILES": scalar("environment-profile", SettingNameList, SettingYardInit, true,
		scopes(ScopeShipped, ScopeHost, ScopeYard, ScopeCommand), optional()),
	"YARD_TEMPLATE": scalar("environment-profile", SettingName, SettingYardInit, true,
		scopes(ScopeYard, ScopeCommand), optional()),
	"YARD_KIND": scalar("yard-runtime", SettingString, SettingYardInit, true,
		scopes(ScopeShipped, ScopeHost, ScopeYard, ScopeCommand), enum("container", "vm")),
	"YARD_INSTANCE_NAME": scalar("yard-runtime", SettingName, SettingYardInit, true,
		scopes(ScopeShipped, ScopeHost, ScopeYard, ScopeCommand)),
	"OWNER_ENDPOINT": scalar("remote-connection", SettingString, SettingNextCommand, false,
		scopes(ScopeHost, ScopeYard, ScopeCommand), optional()),
	"OWNER_YARD_NAME": scalar("remote-connection", SettingName, SettingNextCommand, false,
		scopes(ScopeHost, ScopeYard, ScopeCommand), optional()),
}
